  ...
  public function safeUp()
  {
    ...
    $this->createTable(
      ...
      [
        ...
        'resize_image1' => $this->string(255)->notNull()->comment('Ресайз изображение 1'),
        'resize_image2' => $this->string(255)->notNull()->comment('Ресайз изображение 2'),
        'resize_image3' => $this->string(255)->notNull()->comment('Ресайз изображение 3'),
        'resize_image4' => $this->string(255)->notNull()->comment('Ресайз изображение 4'),
