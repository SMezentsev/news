          ...
          <div class="widget-categories-list__body" data-collapse data-collapse-opened-class="widget-categories-list--open">
            <ul class="widget-categories-list__root">
              <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children" data-collapse-item>
                ...
                <ul class="widget-categories-list__child">
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Turn Signals</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Fog Lights</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Headlights</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Switches & Relays</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Tail Lights</a>
                  </li>
                </ul>
                <ul class="widget-categories-list__child" data-collapse-content>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Corner Lights</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Off-Road Lighting</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Lighting Accessories</a>
                  </li>
                </ul>
              ...
              <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children" data-collapse-item>
                ...
                <ul class="widget-categories-list__child">
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Floor Mats</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Gauges</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Consoles & Organizers</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Mobile Electronics</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Steering Wheels</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Cargo Accessories</a>
                  </li>
                </ul>
              </li>
              <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children" data-collapse-item>
                ...
                <ul class="widget-categories-list__child">
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Air Filters</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Oxygen Sensors</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Heating</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Exhaust</a>
                  </li>
                  <li class="widget-categories-list__child-item">
                    <a href="" class="widget-categories-list__child-link">Cranks & Pistons</a>
                  </li>
                </ul>
              </li>
              <li class="widget-categories-list__root-item" data-collapse-item>
                <a href="" class="widget-categories-list__root-link">Repair Manuals</a>
              </li>
              <li class="widget-categories-list__root-item" data-collapse-item>
                <a href="" class="widget-categories-list__root-link">Suspension</a>
              </li>
              <li class="widget-categories-list__root-item" data-collapse-item>
                <a href="" class="widget-categories-list__root-link">Fuel Systems</a>
              </li>
              <li class="widget-categories-list__root-item" data-collapse-item>
                <a href="" class="widget-categories-list__root-link">Air Filters</a>
              </li>
            </ul>
          </div>
        </div>
