...
use app\components\CatalogSideBarWidget;
use common\components\FormWidget;
...
-->
            ...
            <div class="product__header">
              <h1 class="product__title">Тормозной комплект Brandix BDX-750Z370-S</h1>
              ...
              <div class="product__info-card">
                ...
                <div class="product-form product__form">
                  <div class="product-form__body">
                    <div class="product-form__row">
                      <div class="product-form__title">Материал</div>
                      <div class="product-form__control">
                        <div class="input-radio-label">
                          <div class="input-radio-label__list">
                            <label class="input-radio-label__item">
                              <input type="radio" name="material" class="input-radio-label__input">
                              <span class="input-radio-label__title">Сталь</span>
                            </label>
                            <label class="input-radio-label__item">
                              <input type="radio" name="material" class="input-radio-label__input">
                              <span class="input-radio-label__title">Алюминий</span>
                            </label>
                            <label class="input-radio-label__item">
                              <input type="radio" name="material" class="input-radio-label__input" disabled>
                              <span class="input-radio-label__title">Торий</span>
                            </label>
                          </div>
                        </div>
                      </div>
                ...
                <div class="product__actions">
                  ...
                  <div class="product__actions-item product__actions-item--addtocart">
                    <button class="btn btn-primary btn-lg btn-block">В корзину</button>
                  </div>
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z" />
                    ...
                    <div class="shop-features__info">
                      ...
                      <div class="shop-features__item-subtitle">При заказе от 50 $</div>
                    </div>
                  </li>
    ...
    c0.865,1.414,0.61,3.243-0.524,4.383L10.586,4.788C12.12,4.295,13.864,4.903,14.728,6.314L14.728,6.314z M14.728,6.314" />
                    ...
                    <div class="shop-features__info">
                      ...
                      <div class="shop-features__item-subtitle">Звоните нам в любое время</div>
                    </div>
                  </li>
                  <li class="shop-features__divider" role="presentation"></li>
                  <li class="shop-features__item">
              ...
              <div class="product-tabs__content">
                <div class="product-tabs__pane product-tabs__pane--active" id="product-tab-description">
                  <div class="typography">
                    <h4>Преимущества дисковых тормозов перед барабанными</h4>
                    <p>
                      К преимуществам дисковых тормозов по сравнению с барабанными можно отнести следующие их качества:
                    <ol>
                      <li>тормозная способность дисковых систем не снижается из-за перегрева, так как они лучше охлаждаются;</li>
                      <li>сопротивление дисковых тормозов воздействию воды и загрязнениям выше;</li>
                      <li>техническое обслуживание тормозных механизмов требуется гораздо реже;</li>
                      <li>поверхность трения дисковых тормозов при одинаковой массе больше, чем у барабанных.</li>
                    </ol>
                    </p>
                    <h4>Вентилируемые дисковые тормоза</h4>
                    <p>
                  ...
                  <div class="spec">
                    <div class = "spec__section">
                      ...
                      <div class = "spec__row">
                        ...
                        <div class = "spec__value"> Алюминий, пластик </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Тип двигателя </div>
                        <div class = "spec__value"> Бесщеточный </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Напряжение батареи </div>
                        <div class = "spec__value"> 18 В </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Тип батареи </div>
                        <div class = "spec__value"> Литиум </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Количество скоростей </div>
                        <div class = "spec__value"> 2 </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Время зарядки </div>
                        <div class = "spec__value"> 1,08 ч </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Вес </div>
                        <div class = "spec__value"> 1,5 кг </div>
                      </div>
                    </div>
                    <div class = "spec__section">
                      ...
                      <div class = "spec__row">
                        ...
                        <div class = "spec__value"> 99 мм </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Ширина </div>
                        <div class = "spec__value"> 207 мм </div>
                      </div>
                      <div class = "spec__row">
                        <div class = "spec__name"> Высота </div>
                        <div class = "spec__value"> 208 мм </div>
                      </div>
                    </div>
                    <div class = "spec__disclaimer">
                      Информация о технических характеристиках, комплекте поставки, стране производителя и внешнем виде.
                      Информация о товарах предназначена только для справки и основана на последней информации, доступной на момент публикации.
                    </div>
                  </div>
                </div>
                            ...
                            <div class="review">
                              <div class="review__body">
                                ...
                                <div class="review__meta">
                                  <div class="review__author">Анна Суматохина</div>
                                  <div class="review__date">27 May, 2020</div>
                                </div>
                                ...
                                <div class="review__content typography">
                                  Покупала прямо в СТО. Отличные диски, долго изнашевались. Красивый цвет тормозной системы
                                </div>
                              </div>
                            </div>
                          </li>
                          <li class="reviews-list__item">
                            <div class="review">
                              <div class="review__body">
                                ...
                                <div class="review__meta">
                                  <div class="review__author">Адам Киргизов</div>
                                  <div class="review__date">12 April, 2020</div>
                                </div>
                                <div class="review__rating">
                                  <div class="rating">
                                    <div class="rating__body">
                                ...
                                <div class="review__content typography">
                                  Дороговато, как по мне. Можно найти аналогичные дешевле и прослужать столько же.. зачем переплачвать не понятно
                                </div>
                              </div>
                            </div>
                          </li>
                          <li class="reviews-list__item">
                            <div class="review">
                              <div class="review__body">
                                ...
                                <div class="review__meta">
                                  <div class="review__author">Елена Брежнева</div>
                                  <div class="review__date">2 January, 2020</div>
                                </div>
                                <div class="review__rating">
                                  <div class="rating">
                                    <div class="rating__body">
                                ...
                                <div class="review__content typography">
                                  покупала в прошлом году ... и года не отслужили по городу. Сказали - надо менять ...
                                </div>
                              </div>
                            </div>
                          </li>
                        ...
                        <div class="col-xxl-12 col-xl-10 col-12">
                          <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="review-stars">Оцените</label>
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control" id="review-author" placeholder="">
                            </div>
                            <div class="form-group col-md-4">
                              <label for="review-email">Email</label>
                              <input type="text" class="form-control" id="review-email" placeholder="">
                            </div>
                          </div>
                ...
                <div class="product-tabs__pane" id="product-tab-analogs">
                  <table class="analogs-table">
                    <thead>
                    <tr>
                      <th class="analogs-table__column analogs-table__column--name">Имя</th>
                    ...
                    <tr>
                      <td class="analogs-table__column analogs-table__column--name">
                        <a href="" class="analogs-table__product-name">Комплект тормозов Sunset</a><br>
                      ...
                      <td class="analogs-table__column analogs-table__column--vendor" data-title="Vendor">
                        Sunset
                        <div class="analogs-table__country">(Германия)</div>
                      </td>
                      <td class="analogs-table__column analogs-table__column--price">$1259.00</td>
                    </tr>
                    <tr>
                      <td class="analogs-table__column analogs-table__column--name">
                        <a href="" class="analogs-table__product-name">Комплект тормозов Spectre</a><br>
                      ...
                      <td class="analogs-table__column analogs-table__column--vendor" data-title="Vendor">
                        Specter
                        <div class="analogs-table__country">(Китай)</div>
                      </td>
                      <td class="analogs-table__column analogs-table__column--price">$799.00</td>
                    </tr>
                    <tr>
                      <td class="analogs-table__column analogs-table__column--name">
                        <a href="" class="analogs-table__product-name">Комплект тормозов </a><br>
          ...
          <div class="container">
            <div class="section-header">
              <div class="section-header__body">
                <h2 class="section-header__title">Сопутствующие товары</h2>
