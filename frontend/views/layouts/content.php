...
<meta name="description"
	content="eMarket - Multipurpose Shopify theme is modern, user friendly, responsive and functional theme that is ideal for you to start up any kinds of business stores.">
...
<script
	src="js/api.jquery-e94e010e92e659b566dbc436fdfe5242764380e00398907a14955ba301a4749f.js"></script>
<script src="js/libs.js"></script>
<script src="js/wish-list.js"></script>
<script src="js/owl.carousel.min.js"></script>
<script
	src="js/option_selection-fe6b72c2bbdd3369ac0bfefe8648e3c889efca213baefd4cfb0dd9363563831f.js"></script>
<script src="js/sticky-kit.min.js"></script>



<script src="js/jquery.themepunch.tools.min.js?2" type="text/javascript"></script>
<script src="js/jquery.themepunch.revolution.min.js?2"
...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
	rel="stylesheet">
<link href="css/ss_slider.css?2" rel="stylesheet" type="text/css"
	media="all">
<link rel="stylesheet" href="css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="css/slick.css">
<link href="css/icon" rel="stylesheet">
<link href="css/theme-config.scss.css" rel="stylesheet" type="text/css"
	media="all">
<link href="css/theme-style.scss.css" rel="stylesheet" type="text/css"
	media="all">
<link href="css/theme-sections.scss.css" rel="stylesheet"
	type="text/css" media="all">
<link href="css/theme-responsive.scss.css" rel="stylesheet"
	type="text/css" media="all">
...
<link href="css/jquery.fancybox.css" rel="stylesheet" type="text/css"
	media="all">
<link rel="stylesheet"
	href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/fonts/fontawesome-webfont.woff2?v=4.7.0">

</head>

<body class="template-index hidden-scorll" style="">
    ...
    //       });
					...
					<div class="wrap">
						<div class="row">
							<div class="vertical_menu col-xl-2 col-lg-3 col-12">
								<div id="shopify-section-ss-vertical-menu"
										...
										<div class="vertical-content">
											...
											<div class="navbar-vertical">
												<button style="background: #ff3c20" type="button"
													...
													<i class="fa fa-bars"></i> <span class="title-nav">ALL
														CATEGORIES</span>
												</button>
		...
		<div class="main-content" id="MainContent">
				...
				<div class="section-bottom">
					<div id="shopify-section-homepage-logolist"
						class="shopify-section home-section">
		...
		<div id="shopify-section-footer" class="shopify-section">
										...
										<div class="col-xl-3 col-lg-3 col-sm-12 col-12 ft-2">
											<div class="collapsed-block footer-block footer-about">
												...
												<ul class="footer-block-content">
													...
													<li class="address"><span>San Luis Potosí, Centro
															Historico, 78000 San Luis Potosí, SPL, Mexico</span></li>
            ...
            <div id="shopify-section-ss-tools" class="shopify-section">
                ...
                <script src="js/ss_tools.js?13" type="text/javascript"></script>
