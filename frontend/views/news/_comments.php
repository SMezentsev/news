      ...
      <div class="user justify-content-between d-flex">
        ...
        <div class="desc">
          <p class="comment">
            ...
            in his works. Start writing, no matter what. The water does not flow until the faucet is turned on.
          </p>
  ...
  <div class="comment-list">
    <div class="single-comment justify-content-between d-flex">
      <div class="user justify-content-between d-flex">
        ...
        <div class="desc">
          <p class="comment">
            So read on to find some apt quotes for all writing occasions from considering to be a writer to
            experiencing a writers block to have already created that masterpiece yet contemplating if it’s good
            enough.
          </p>
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
