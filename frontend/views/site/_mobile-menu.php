    ...
    <div class="mobile-menu__panel">
      ...
      <div class="mobile-menu__panel-body">
        ...
        <div class="mobile-menu__indicators">
          <a class="mobile-menu__indicator" href="favorites">
...
c-1.5,0-2.9,0.6-4,1.5C8.9,1.6,7.5,1,6,1C2.7,1,0,3.7,0,7c0,5,6,12,10,12s10-7,10-12C20,3.7,17.3,1,14,1L14,1z" />
        ...
        c0,1.9-0.9,3.6-2.3,4.7C17.4,12.2,20,15.8,20,20z M14,6c0-2.2-1.8-4-4-4S6,3.8,6,6s1.8,4,4,4S14,8.2,14,6z" />
            ...
            <span class="mobile-menu__indicator-title">Л. кабинет</span>
          </a>
...
C15.5,10.2,14,11.3,14,12z" />
            ...
            <div class="mobile-menu__links-panel" data-mobile-menu-panel>
              <div class="mobile-menu__panel mobile-menu__panel--hidden">
                <div class="mobile-menu__panel-header">
                  ...
                  <div class="mobile-menu__panel-title">Личный кабинет</div>
                </div>
                <div class="mobile-menu__panel-body">
                  <ul class="mobile-menu__links">
                    <li data-mobile-menu-item>
                    ...
                    <li data-mobile-menu-item>
                      <a href="/profile" class="" data-mobile-menu-trigger>
                        Мои данные
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/history" class="" data-mobile-menu-trigger>
                        История заказов
                      </a>
                    </li>
                    <?php if(0) { ?>
                    <li data-mobile-menu-item>
                      <a href="/addresses" class="" data-mobile-menu-trigger>
                        Мои адреса
                      </a>
                    </li>
                    <?php } ?>
                    <li data-mobile-menu-item>
                      <a href="/password" class="" data-mobile-menu-trigger>
                        Изменить пароль
                      </a>
                    </li>
                    <li data-mobile-menu-item>
        ...
        C-0.1,9.8-0.1,10.4,0.3,10.7z" />
          ...
          <li data-mobile-menu-item>
            <a href="/news" class="highlight" data-mobile-menu-trigger>
              Новости
            </a>
          </li>
        ...
        C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                    ...
                    <li data-mobile-menu-item>
                      <a href="/cart" class="" data-mobile-menu-trigger>
                        Cart
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/checkout" class="" data-mobile-menu-trigger>
                        Checkout
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/order" class="" data-mobile-menu-trigger>
                        Order Success
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/wishList" class="" data-mobile-menu-trigger>
                        Wishlist
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/compare" class="" data-mobile-menu-trigger>
                        Compare
                      </a>
                    </li>
                    <li data-mobile-menu-item>
                      <a href="/trackOrder" class="" data-mobile-menu-trigger>
                        Track Order
                      </a>
                    </li>
                  </ul>
