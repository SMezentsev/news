  ...
  <div class="container" style="transform: none;">
    ...
    <div class="row mb-50" style="transform: none;">
      ...
      <div class="col-lg-4 col-md-12 sidebar-right sticky-sidebar" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
        ...
        <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; top: 0px; left: 1046.05px;"><div class="pl-lg-50">
            <!--Post aside style 1-->
    ...
    <div class="row mb-50">
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="sidebar-widget mb-md-30">
          ...
          <div class="post-aside-style-2">
            <ul class="list-post">
              <li class="mb-30 wow fadeIn animated" style="visibility: hidden; animation-name: none;">
                <div class="d-flex">
                  <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                    <a class="color-white" href="single.html">
              ...
              <li class="wow fadeIn animated" style="visibility: hidden; animation-name: none;">
                <div class="d-flex">
                  <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                    <a class="color-white" href="single.html">
                      <img src="assets/imgs/thumbnail-15.jpg" alt="">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="sidebar-widget p-20 border-radius-15 bg-white widget-latest-comments wow fadeIn  animated" style="visibility: hidden; animation-name: none;">
          <div class="post-block-list post-module-6">
            <div class="last-comment mb-20 d-flex wow fadeIn" style="visibility: hidden; animation-name: none;">
            ...
            <div class="last-comment d-flex wow fadeIn" style="visibility: hidden; animation-name: none;">
                                    <span class="item-count vertical-align">
