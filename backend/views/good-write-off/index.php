...
<?= PanelWidget::start(true, [
  'body'=> [
    'style' => 'background-color:#ffabab !important'
  ]
]); ?>
    ...
    <ul class="nav nav-tabs flex-nowrap text-nowrap">
      <li class="nav-item">
        <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active"
           data-bs-toggle="tab" href="#search">Списания</a>
      </li>
    </ul>
  </div>
</div>
...
<?= PanelWidget::start(); ?>
    <?= \kartik\grid\GridView::widget([
      ...
      'toolbar' => [
        [
          'content' =>
            Html::a('<i class="fas fa-redo"></i>', ['/good-write-off'], [
...
//          'afterGrid'=>'My fancy content after.',
      ...
      'columns' => [
        ...
        [
          'hAlign' => 'center',
          'vAlign' => 'middle',
          'attribute' => 'good_write_off_status_id',
          'format' => 'raw',
          'filter' => false,
          'value' => function ($model) {
        ...
        [
          ...
          'buttons' => [
            'edit' => function ($url, $model) {
              ...
              return '<a href="/good-write-off/' . $model->id . '" class="menu-link px-3" data-pjax="0">
            ...
            'delete' => function ($url, $model) {
              return Html::a('
                  ...
                  ',
                ['/good-write-off/' . $model->id . '/delete'],
                ['data-pjax' => 0]
              );
            },
          ],
