...
<div class="card-header pt-10">
  <div class="d-flex align-items-center">
    ...
    <div class="d-flex flex-column">
      <h2 class="mb-1"><?= $model->number??'' ?> - <?= $model->good->counterparty->name ?? '' ?></h2>
      ...
      if($goodId = $model->good->id ?? false) {
        ...
        if ($model->good->id ?? false) {
          ...
          $clientPrice = $model->price??MoneyHelper::price($model->price/100);
          $delta = $model->price??MoneyHelper::price($model->price/100 - $total);
