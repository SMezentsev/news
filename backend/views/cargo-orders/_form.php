...
<div class="row">
  <div class="col-md-12">
    <?= $form->field($model, 'address_start'); ?>
  </div>
</div>
<div class="row">
  <div class="col-md-3">
    <?= $form->field($model, 'lat_start')->label('Долгота'); ?>
  </div>
  <div class="col-md-3">
    <?= $form->field($model, 'lon_start')->label('Широта'); ?>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
    <?= $form->field($model, 'address_end'); ?>
  </div>
</div>
<div class="row">
  <div class="col-md-3">
    <?= $form->field($model, 'lat_end')->label('Долгота'); ?>
  </div>
  <div class="col-md-3">
    <?= $form->field($model, 'lon_end')->label('Широта'); ?>
  </div>
</div>
